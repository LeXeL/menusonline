<template>
    <q-page class="bg-grey-2">
        <q-img
            :src="require('@/assets/wp/deliciasbocatorenas/logo.jpeg')"
            class="shadow-7"
        />
        <div class="q-pa-md">
            ...
            >
                <q-img
                    v-if="item.pic"
                    :src="
                        require(`@/assets/wp/deliciasbocatorenas/${item.pic}`)
                    "
                />
...
export default {
    ...
    data() {
        return {
            ...
            menu: [
                {
                    title: 'Mondongo a La Culona',
                    desc: 'Delicioso mondongo con sabor de la casa.',
                ...
                {
                    title: 'Mono Arroz con Pollo',
                    desc: 'Arroz con pollo y tajadas maduras.',
                    options: [{title: 'Regular', price: 0}],
                    pic: 'arroz.jpeg',
                    price: 3,
                    type: 'main',
    ...
    methods: {
        ...
        geolocate() {
            navigator.geolocation.getCurrentPosition(
                ...
                error => {
                    this.center = {
                        lat: parseFloat(8.956516),
                        lng: parseFloat(-79.549752),
                    }
                    this.markers.push({position: this.center})
                }
            )
