<template>
    <q-page class="bg-grey-2">
        <q-img :src="require('@/assets/wp/elpatacon/logo.jpg')" class="shadow-7" />
        <div class="q-pa-md">
            ...
            <q-card class="full-width q-mb-lg" v-for="(item, i) in menu" :key="i">
                ...
                <q-card-actions>
                    <q-space />
                    <q-btn flat color="green-7" @click="selectItem(i)">Agregar</q-btn>
                </q-card-actions>
            </q-card>
            <!-- END MENU ITEMS -->
                            ...
                            <div class="col">
                                <div class="text-body2 poppins-regular">
                                    <template v-if="item.type == 'main'">
                                        <strong>
                                            ({{ item.amount }}) {{ item.title }} - {{ item.options.title }}
                                            <span
                                                v-if="Object.keys(item.styles).length > 0"
                                            >- {{ item.styles.title }}</span>
                                            <span
                                                v-if="Object.keys(item.sides).length > 0"
                                            >- {{ item.sides.title }}</span>
                                        </strong>
                                    </template>
                                </div>
                            </div>
            ...
            <q-dialog v-model="seamless" seamless position="bottom">
                <q-card style="width: 350px; border-radius: 0;" class="bg-green-7 text-white">
...
export default {
    ...
    data() {
        return {
            ...
            menu: [
                {
                    title: '1/4 Pollo Rostizado',
                    desc:
                        '1/4 de pollo rostizado con papitas o patacones y soda.',
                    type: 'main',
                    pic: '',
                    count: 0,
                    price: 2,
                ...
                {
                    title: '1/2 Pollo Rostizado',
                    desc: '1/2 pollo rostizado con papitas o patacones y soda.',
                    type: 'main',
                    pic: '',
                    count: 0,
                    price: 2,
                ...
                {
                    title: 'Pollo Rostizado Entero',
                    desc:
                        '1/2 pollo rostizado con papitas o patacones y soda 1.5.',
                    type: 'main',
                    pic: '',
                    count: 0,
                    price: 2,
                ...
                },
                {
                    title: 'Pollo Apanado',
                    desc:
                        'Pollo apanados 2 presas con papitas o patacones y soda.',
                    type: 'main',
                    pic: '',
                    count: 0,
                    price: 2,
                ...
                },
                {
                    ...
                    desc:
                        'Hamburguesa de carne con papitas o patacones y soda.',
                    type: 'main',
                    pic: '',
                    count: 0,
                    price: 2,
    ...
    methods: {
        ...
        generateMessage() {
            ...
            for (let item of this.cart) {
                if (item.type == 'main') {
                    ...
                    if (Object.keys(item.sides).length > 0) {
        ...
        async sendChat() {
            ...
            if (this.selectedPaymentMethod == null) {
                ...
                this.$analytics.logEvent('wp-elpatacon', {
