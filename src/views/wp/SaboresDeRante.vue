<template>
    <q-page class="bg-grey-2">
        <q-img
            :src="require('@/assets/wp/saboresderante/logo.jpg')"
            class="shadow-7"
        />
        <div class="q-pa-md">
            ...
            <div v-for="(item, i) in filterMenu(menu)" :key="i">
                <div v-if="item.title == 'Torrejitas de Bacalao'">
                    <div
                ...
                <div v-if="item.title == 'Filete de pescado'">
                    <div
                        class="text-h6 text-center q-my-lg text-orange-9 poppins-bold"
                    >
                        PLATOS FUERTES
                ...
                <div v-if="item.title == 'Acompañamiento extra'">
                    <div
                        class="text-h6 text-center q-my-lg text-orange-9 poppins-bold"
                    >
                        EXTRAS
                ...
                <div v-if="item.title == 'Flan de la casa'">
                    <div
                        class="text-h6 text-center q-my-lg text-orange-9 poppins-bold"
                    >
                        POSTRES
                ...
                <q-card class="full-width q-mb-lg">
                    ...
                    <q-card-section class="q-pb-none">
                        <div class="row">
                            ...
                            <div
                                class="text-subtitle2 poppins-bold text-green-8 full-width"
...
export default {
        ...
        return {
            ...
            menu: [
...

                {
                    title: 'Wicked Wings',
                    subtitle: '',
                    desc: 'Elija entre 6 o 12 unidades de alitas.',
                    type: 'starter',
                    pic: '',
                    price: 0,
                    count: 0,
                    options: [
                        {title: '6 Unidades', price: 6},
                        {title: '12 unidades', price: 10},
                    ],
                    styles: [],
                    sides: [],
                },
                ...
                {
                    title: 'Choripan Rante',
                    subtitle: '',
                    desc: 'Choripan con chorizo tableño',
                    type: 'starter',
                    pic: '',
                    price: 3.5,
                    count: 0,
...

                {
                    ...
                    subtitle: '',
                    desc:
                        'Acompañado de arroz con coco, ensalada y platano en tentacion.',
                    type: 'main',
                    pic: '',
                    price: 7.5,
                    count: 0,
...

                {
                    ...
                    subtitle: '',
                    desc:
                        'Arroz con coco, rabitos, camarones secos, y Bacalao. Acompañado de arroz con coco, ensalada y platano en tentacion.',
                    type: 'main',
                    pic: '',
                    price: 9.5,
                    count: 0,
                ...
                {
                    title: 'Pollo al Curry en salsa de coco',
                    subtitle: '',
                    desc:
                        'Acompañado de arroz con coco, ensalada y platano en tentacion.',
                    type: 'main',
...

                {
                    ...
                    subtitle: "Especialidades D'Rante",
                    desc:
                        'Acompañado de arroz con coco, ensalada y platano en tentacion.',
                    type: 'specialties',
                    pic: '',
                ...
                {
                    title: 'Acompañamiento extra',
                    subtitle: '',
                    desc:
                        'Elija entre arroz con coco, arroz con cilantro, yuca al mojo, ensalada de colslaw o platano ententacion.',
                    type: 'side',
                    pic: '',
                    price: 0,
                    count: 0,
                    options: [
                        ...
                        {title: 'Arroz con cilantro', price: 1.5},
                        {title: 'Yuca al mojo', price: 1.25},
                        {title: 'Ensalada de colslaw', price: 1.5},
                        {title: 'Platano en tentacion', price: 1.5},
                    ],
                    styles: [],
                    sides: [],
                },
    ...
    methods: {
        filterMenu(menu) {
            ...
            if (this.selectedCategory === 'Platos Fuertes') type = 'main'
            if (this.selectedCategory === 'Especialidades') type = 'specialties'
            if (this.selectedCategory === 'Extras') type = 'side'
            if (this.selectedCategory === 'Postres') type = 'dessert'
        ...
        async sendChat() {
            ...
            if (this.selectedPaymentMethod == null) {
                ...
                this.$analytics.logEvent('wp-deliciasderante', {
