    ...
    <q-page class="bg-black text-white">
        ...
        <div class="q-pa-md">
            ...
            <div class="row q-mb-xl">
                ...
                >
                    <strong>Los pedidos para Panama Pacifico & Panama Centro seran entregados el viernes 28 de agosto.</strong>
                </div>
                <div class="text-body2 text-center" v-if="selectedArea == 'Panama Oeste'">
                    <strong>Los pedidos para Panama Oeste seran entregados el saabdo 29 de agosto.</strong>
                </div>
            </div>
            <!-- END SELECT AREA -->
            ...
            <q-dialog v-model="cartDialog">
                <q-card style="width: 700px; max-width: 80vw;" dark v-if="cart.length > 0">
                    ...
                    <q-card-section>
                        <div class="row q-mb-md" v-for="(item, i) in cart" :key="i">
                            ...
                            <div class="col">
                                ...
                                >
                                    <strong>({{ item.amount }}) {{item.title}} con {{item.selectedOption}}</strong>
                                </div>
                    ...
                    <q-card-section>
                        ...
                        >Recuerda enviar el comprobante de pago a nuestro Whatsapp.</div>
                    </q-card-section>
                    <q-card-section>
                        <q-btn
                            color="green-7"
